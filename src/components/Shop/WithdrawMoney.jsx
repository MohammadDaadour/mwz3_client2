    ...
    <div className="w-full h-[90vh] p-8">
      <div className="w-full bg-white h-full rounded flex items-center justify-center flex-col">
        <h5 className="text-[20px] pb-4">
          المبلغ المتاح: ج.م{availableBalance}
        </h5>
        <div
          className={` text-white bg-red-600 hover:text-red-600 hover:bg-white cursor-pointer border border-white hover:border-red-600 duration-300 py-3 px-7`}
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    ...
                    <br />
                    <h4>المبلغ المتاح: {availableBalance}$</h4>
                    <br />
